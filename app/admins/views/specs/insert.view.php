        ...
        <form class="form-create-spec" action="/app/admins/tables/specs/insert-spec.php" method="post" enctype="multipart/form-data">
            <div class="spec-info">
                ...
                <div class="form-group div-flex">
                    ...
                    <input value="<?= $_SESSION["date-work"] ?? "" ?>" type="date" name="date-work" class="form-control" id="date-work">
                </div>
                ...
                <div class="form-group div-flex">
                    ...
                    <input value="<?= $_SESSION["office"] ?? "" ?>" type="text" name="office" class="form-control" id="office">
            ...
            <div>
                <div class="form-group div-flex">
                    ...
                    <input value="<?= $_SESSION["diplom"] ?? "" ?>" type="number" name="diplom" class="form-control" id="diplom">
                ...
                <div class="form-group div-flex">
                    ...
                    <input value="<?= $_SESSION["univer"] ?? "" ?>" type="text" name="univer" class="form-control" id="univer">
                ...
                <div class="form-group div-flex">
                    ...
                    <input value="<?= $_SESSION["qualification"] ?? "" ?>" type="text" name="qualification" class="form-control" id="qualification">
                ...
                <div class="form-group div-flex">
                    ...
                    <input value="<?= $_SESSION["year_of_issue"] ?? "" ?>" type="number" name="year_of_issue" class="form-control" id="year_of_issue">
                ...
                <div class="form-group div-flex">
                    ...
                    <input value="<?= $_SESSION["year_of_graduation"] ?? "" ?>" type="number" name="year_of_graduation" class="form-control" id="year_of_graduation">
